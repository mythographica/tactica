...
*/
    ...
    generateCompleteInstanceInterface(node, lines) {
        ...
        const propertiesForInstanceType = node.declaredProperties && node.declaredProperties.size > 0
    ...
    generateConstructorSignature(node) {
        ...
        const params = node.declaredConstructorParams && node.declaredConstructorParams.length > 0
