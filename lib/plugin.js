 ...
 */
function getLookupTypedDefinition(fileName, position, info, tsModule) {
 ...
 */
function findTokenAtPosition(sourceFile, position, tsModule) {
 ...
 */
function getFunctionName(expr, tsModule) {
